...
class MainActivity : AppCompatActivity() {
        ...
        when (requestCode) {
            PERMISSION_CODE_IMAGE_PICK -> {
                if (grantResults.size > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(this, "Permissão de Acesso a Galeria Negada", Toast.LENGTH_LONG)
                        .show()
                }
            }
            ...
            PERMISSION_CODE_CAMERA_CAPTURE -> {
                if (grantResults.size > 1 &&
                    ...
                    Toast.makeText(this, "Permissão de Acesso a Câmera Negada", Toast.LENGTH_LONG)
                        .show()
                }
            }
        }
    ...
    private fun openCamera() {
        ...
        values.put(MediaStore.Images.Media.TITLE, "nova_foto")
